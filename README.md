...
生产环境部署、回滚与验证流程见 [DEPLOY.md](DEPLOY.md)。
...
题型分布：单选 23452、主观 4136、多选 641、填空 373、判断 256。难度分布：基础 7238、中等 20394、较难 1226。
...
- **V1.9（当前）**：题库扩充至 28858 题，AI 补强数学（+158）与政治（+61）薄弱章节，并归一化数学/政治章节名
- **V1.8**：题库扩充至 28641 题，AI 补强通用技术（+169）与信息技术（+194）薄弱章节
